...
data <- 
  ...
  c(
    ...
    "Actuarial reserving",    "",                    "",               "",             
  c(
    "Provide support in statutory liability valuation for general (re)insurance companies in Malaysia, Philippines and Sri Lanka."
    ),
...
data <- 
  ...
  "Minitab - Salsford Predictive Modeling (Treenet)",
  ...
  "Azure: Setting up linux virtual machine for shiny deployment",
...
data <- 
  ...
  "Raw data consisting of customer information was given to each team. The data stipulated actual data (dirty and unorganized). Microsoft Excel and SAS Enterprise Miner were used for data cleansing and table merging.", 
  "SAS Enterprise Guide was used to analyze the clean data and to develop predictive models, i.e: Tree, Neural Network, Regression.", 
