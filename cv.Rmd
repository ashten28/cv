...
position: Actuarial + Data Science
...
data <- 
  ...
  # Hannover Re
  "Cross-selling analysis with profit maximisation", "Nov. 2020 - Present", "Hannover Re - Regional P&C Analyst", "KL, Malaysia", 
  c("Delivered excel-based analysis that indicates profitable treaties for underwriters to cross-sell during renewal negotiations.",
  ...
  c("Provided support in compiling and visualising Australian non-life market statistics. Data utilised here were published by Australian Prudential Regulation Authority (APRA).",    
  ...
  c(
    ...
    "Support includes data cleaning, data checking and data preparation of raw claims and premium data for Ms Excel analysis"
    ),
  ...
  c(
    ...
    "Support includes data cleaning, data checking and data preparation of exposure data for MS Excel analysis", 
...
data <- 
  ...
  c("Worked in a group of 3 while competing with 51 other teams to build the best business proposal using statistical analysis.", 
